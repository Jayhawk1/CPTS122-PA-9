...
void Room::drawWalls(sf::RenderWindow& window) {
	...
	for (auto& d : doors) {
		d.draw(window, d.getIsRec());
	}

	nextDoor.draw(window, true);
}

void Room::buildRoom1() {
	setRoomNum(ROOM1);

	// Door(int mShape, float posX, float posY, float sizeX, float sizeY, sf::Color outline, sf::Color fill, bool isOpen)
	lastDoor = doors.emplace_back(2, 20.f, 400.f, 10.f, 50.f, toSFMLColor(NONE), toSFMLColor(RED), false);
	nextDoor = doors.emplace_back(2, 1250.f, 400.f, 10.f, 50.f, toSFMLColor(NONE), toSFMLColor(RED), false);
	...
	paint.emplace_back(spinColor(), sf::Vector2f(1200.f, 600.f));
...
void Room::buildRoom2() {
	...
	paint.emplace_back(spinColor(), sf::Vector2f(1200.f, 200.f));
	paint.emplace_back(spinColor(), sf::Vector2f(1200.f, 600.f));
	spacer += 70.f;
}
...
void Room::buildRoom3() {
	setRoomNum(ROOM3);
	nextDoor = doors.emplace_back(2, 650.f, 20.f, 50.f, 10.f, toSFMLColor(NONE), toSFMLColor(RED), false);
	lastDoor = doors.emplace_back(2, 650.f, 680.f, 50.f, 10.f, toSFMLColor(NONE), toSFMLColor(RED), false);
	...
	paint.emplace_back(spinColor(), sf::Vector2f(450.f, 200.f));
	paint.emplace_back(spinColor(), sf::Vector2f(750.f, 600.f));
	paint.emplace_back(spinColor(), sf::Vector2f(600.f, 400.f));
	paint.emplace_back(spinColor(), sf::Vector2f(420.f, 350.f));
}
...
void Room::buildRoom4() {
	...
	lastDoor = doors.emplace_back(2, 20.f, 350.f, 10.f, 50.f, toSFMLColor(NONE), toSFMLColor(RED), false);
	nextDoor = doors.emplace_back(2, 1250.f, 350.f, 10.f, 50.f, toSFMLColor(NONE), toSFMLColor(RED), false);
